...
export const useHttp = () => {
  //внутри этого хука будем сами определять, грузится что-то или нет. и будем работать с этим флагом
  ...
  const request = useCallback(
    async (url, method = "POST", body = null, headers = {}) => {
      // useCallback первый параметр набор зависимостей второй параметр пустй объект [] он ниже
      ...
      try {
        ...
        if (!response.ok) {
          // если при запросе возникла ошибка
